...
liste_cols = ["client_nom", "client_prenom", "client_telephone", "employe_nom", "employe_prenom", "employe_salaire", "reparation_date_entree", "reparation_date_sortie", "reparation_temps", "reparation_prix", "location_type", "location_prix_ht", "piece_stock", "piece_quantite_utilisee"]

df_le_havre = load_and_tag_ville("raw_le_havre", liste_cols, "Le Havre")
...
df_montauban = load_and_tag_ville("raw_montauban", liste_cols, "Montauban")
...
df_nancy = load_and_tag_ville("raw_nancy", liste_cols, "Nancy")
...
df_lyon = load_and_tag_ville("raw_lyon", liste_cols, "Lyon")
