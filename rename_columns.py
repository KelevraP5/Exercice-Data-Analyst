...
cols_client = ["id", "client_nom", "client_prenom", "client_telephone"]
cols_employes = ["id", "employe_nom", "employe_prenom", "employe_poste", "employe_garage_id", "antenne_id", "employe_salaire"]
cols_loc_pret = ["id", "garage_id", "location_type", "id_voiture", "id_client", "id_tarif_loc", "date_debut_location", "date_fin_location", "location_prix_ht"]
cols_pieces = ["id", "garage_id", "piece_ref", "piece_nom", "piece_prix_achat", "piece_prix_vente", "piece_stock"]
cols_rep_pieces = ["id", "id_reparation", "id_piece", "piece_quantite_utilisee"]
cols_rep = ["id", "garage_id", "id_voiture_client", "id_type_reparation", "reparation_date_entree", "reparation_date_sortie", "reparation_temps", "reparation_prix"]
cols_voiture_client = ["id", "id_client", "client_vehicule_type", "client_vehicule_marque", "client_vehicule_couleur", "client_vehicule_immat"]
cols_voiture_garage = ["id", "garage_vehicule_categorie", "garage_vehicule_marque", "garage_vehicule_couleur", "garage_vehicule_immat", "garage_id"]
...
data_pieces = full_data[cols_pieces].copy()
